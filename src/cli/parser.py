...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("-s", "--submit", metavar="FLAG",
    ...
    parser.add_argument("-e", "--events", nargs="+", metavar="EVENT",
        help="Filter by one or more event name substrings  (-e Finals Quals)")
    parser.add_argument("-S", "--sections", nargs="+", metavar="SECTION",
    ...
    parser.add_argument("-o", "--output", default="data", metavar="DIR",
